(function(){
  ...
  const charts={}; let mode='inflow',sortKey='',sortDir=1,page=1,pageSize=20,tableView='summary',yearExpanded=false,counterpartyFilter='all';
  ...
  const isRelated=row=>rowIndex(row)%8===0;
