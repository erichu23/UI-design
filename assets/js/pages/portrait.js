(function(){
  ...
  const charts={}; let mode='inflow',sortKey='',sortDir=1,page=1; const pageSize=20;
  const fmt=v=>v?Number(v).toLocaleString('zh-CN',{minimumFractionDigits:2,maximumFractionDigits:2}):'—';
  const typeClass=t=>t==='客户'?'is-customer':t==='供应商'?'is-supplier':'is-personal';
